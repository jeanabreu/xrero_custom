...
class RentalPortalWebsite(http.Controller):
    ...
    def rental_user_sell_contract(self):
        ...
        return request.render('xrero_rental_management.rental_user_sell_contract_info', values)
    ...
    def rental_user_sell_contract_detail(self, b):
        if b.customer_id.id == request.env.user.partner_id.id:
            ...
            return request.render('xrero_rental_management.rental_user_sell_contract_details', values)
        else:
    ...
    def rental_user_rent_contract(self):
        ...
        return request.render('xrero_rental_management.rental_user_rent_contract_info',  {'contract': rent_contracts})
    ...
    def rental_user_rent_contract_detail(self, rc):
        ...
        if rc.tenancy_id.id == request.env.user.partner_id.id:
            ...
            return request.render('xrero_rental_management.rental_user_rent_contract_details', values)
        else:
            return request.redirect('/')
    ...
    def rental_user_maintenance_request(self):
        ...
        return request.render('xrero_rental_management.rental_user_maintenance_info',  {'maintenance_rec': maintenance_requests})
    ...
    def rental_user_maintenance_request_details(self, mr):
        return request.render('xrero_rental_management.rental_user_maintenance_details', {'mr': mr.sudo()})
