...
class RentalDashboard extends Component {
    setup() {
        ...
        onWillStart(async () => {
            await loadJS('xrero_rental_management/static/src/js/lib/index.js');
            await loadJS('xrero_rental_management/static/src/js/lib/map.js');
            await loadJS('xrero_rental_management/static/src/js/lib/xy.js');
            await loadJS('xrero_rental_management/static/src/js/lib/worldLow.js');
            await loadJS('xrero_rental_management/static/src/js/lib/Animated.js');
            await loadJS('xrero_rental_management/static/src/js/lib/apexcharts.js');
    ...
    renderPropertyType(div, sessionData) {
        ...
        var data = [{
            ...
            pictureSettings: {
                src: "xrero_rental_management/static/src/img/land-dash.svg"
            }
        }, {
            name: "Residential",
            steps: sessionData['y-axis'][1],
            pictureSettings: {
                src: "xrero_rental_management/static/src/img/re-dash.svg"
            }
        }, {
            name: "Commercial",
            steps: sessionData['y-axis'][2],
            pictureSettings: {
                src: "xrero_rental_management/static/src/img/come-dash.svg"
            }
        }, {
            name: "Industrial",
            steps: sessionData['y-axis'][3],
            pictureSettings: {
                src: "xrero_rental_management/static/src/img/ind-dash.svg"
            }
        }];
...
RentalDashboard.template = "xrero_rental_management.rental_dashboard";
