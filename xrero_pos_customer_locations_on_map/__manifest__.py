...

{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            "xrero_pos_customer_locations_on_map/static/src/js/custMapApi.js",
            "xrero_pos_customer_locations_on_map/static/src/js/BiGoogleMapApi.js",
            'xrero_pos_customer_locations_on_map/static/src/xml/BiGoogleMap.xml',
        ],
     },
