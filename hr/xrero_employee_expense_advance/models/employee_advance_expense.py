...
class EmployeeAdvanceExpense(models.Model):
    ...
    @api.onchange('employee_id', 'employee_id.addreaddress_idss_home_id')
    def get_department(self):
        for line in self:
            ...
            line.partner_id = line.employee_id.sudo().address_id and line.employee_id.address_id.id or False
...
#             category_id = line.asset_id.category_id
            ...
            if not line.account_id:
                    raise UserError(_("Please select debit account on advance request form."))
