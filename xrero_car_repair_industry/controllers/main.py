...
class Appointment(http.Controller):
    ...
    def appointment(self, **post):
        return request.render("xrero_car_repair_industry.appointment_form")
    ...
    def appointment_confirm(self, **post):
        if post:
            ...
            return request.render("xrero_car_repair_industry.appointment_confirm",values)

    @http.route('/service-repair', auth='public', type='http', website=True)
    def service_repair_form(self, **post):
        return request.render("xrero_car_repair_industry.service_repair_form")
    ...
    def service_repair_form_submit(self, **post):
        if post:
            ...
            return request.render("xrero_car_repair_industry.service_repair_form_submit", values)
    ...
    def feedback_form(self, repair, **post):
        ...
        return request.render("xrero_car_repair_industry.feedback_form", values)
    ...
    def feedbacksubmit(self, **post):
        ...
        return request.render("xrero_car_repair_industry.review_submit", values)
